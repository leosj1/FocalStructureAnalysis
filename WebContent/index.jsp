...
<link rel="stylesheet"  href="css/style.css"/>
    ...
    <script>
    //put the google analytics script here!
    </script>
  </head>
      ...
      <div id="content">
        ...
        <div id="divVisualFeatures" class="visFeatures">
          ...
          <div id="divNodeStyle" class="visItem">
            Node Style:
            <select id="nodeStyle" name="nodeStyle">
        ...
        <div id="divResultLabel" class="visFeatures">
          <br>
          <div class="visItem">
            The nodes with a same color represent a focal structure, whereas the grey nodes are not included in a focal structure at all.
            <!--<a id="linkExportFocalStructures" href="">Export Focal structures</a>-->
          </div>
        </div>

        <%-- D3.js graph viz canvas --%>
        <div id="d3vis" class="d3Style">
        </div>
        ...
        <div id="existingNetwork" class="formBox" style="height:390px;">
          <form id="ExistingNetworkForm">
            ...
            <select id="network_file" name="network_file" style="width:100%;">
              ...
              <input id="btnFSAW" type="button" value="Apply FSA (For Weighted Graph)" />
              <%-- TODO: These buttons don't do anything --%>
              <input id="btnClusteringCoefficient" type="button" class="btnAlgorithm" value="Clustering Coefficient" />
              <input id="btnDegreeCentrality" type="button" class="btnAlgorithm" value="Degree Centrality" />
              <input id="btnPageRank" type="button" class="btnAlgorithm" value="Page Rank" />
              <input id="btnBetweenness" type="button" class="btnAlgorithm" value="Betweenness" />
              <input id="btnModularity" type="button" class="btnAlgorithm" value="Modularity" />
              <input id="btnSimilarity" type="button" class="btnAlgorithm" value="Similarity" />
              <input id="btnDijkstra" type="button" class="btnAlgorithm" value="Dijkstra's Algorithm" />
          </form>
        </div>

        <%-- TODO WHY inline styles??? --%>
        <div style="color:#000; text-align: center; margin:0 auto;width:100%">
            Or
        </div>

        <div class="formBox">
          <form id="UploadForm" action="UploadFileServlet" method="post"
          enctype="multipart/form-data">
            <div id="divNetworkType" style="float:left;">
              <label>
                Upload a network file! Only .gdf and .csv formats are supported!
              </label>
              <br/>
              <!--<input type="checkbox" id="chkNetworkType" name="chkNetworkType"> Directed Network-->
            </div>

            <input type="file" size="15" id="myfile" name="myfile" style="color:black;">
            ...
            <input id="btnFSA2" type="button" value="Apply FSA" />
            <input id="btnClusteringCoefficient2" type="button" class="btnAlgorithm" value="Clustering Coefficient" />
            <input id="btnDegreeCentrality2" type="button" class="btnAlgorithm" value="Degree Centrality" />
            <input id="btnPageRank2" type="button" class="btnAlgorithm" value="Page Rank" />
            <input id="btnBetweenness2" type="button" class="btnAlgorithm" value="Betweenness" />
            <input id="btnModularity2" type="button" class="btnAlgorithm" value="Modularity" />
            <input id="btnSimilarity2" type="button" class="btnAlgorithm" value="Similarity" />
            <input id="btnDijkstra2" type="button" class="btnAlgorithm" value="Dijkstra's Algorithm" />
          </form>
        </div>
      </div><!-- menu -->
    </div><!-- container -->
